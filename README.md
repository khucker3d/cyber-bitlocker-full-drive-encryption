...
This project documents enabling full disk encryption using BitLocker on Windows 11 Pro to protect data at rest.

BitLocker ensures that sensitive data remains protected if a device is lost, stolen, or accessed outside of a trusted boot environment.
...
Confirmed TPM is present and ready.
Get-Tpm
